...
export const SERVICE_TOP_REQUEST = 'SERVICE_TOP_REQUEST'
export const SERVICE_TOP_SUCCESS = 'SERVICE_TOP_SUCCESS'
export const SERVICE_TOP_FAIL = 'SERVICE_TOP_FAIL'
